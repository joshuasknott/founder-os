...
export const connectorRegistry: Record<string, ConnectorDefinition> = {
  ...
  google_drive: {
    ...
    description: "Find relevant Drive files, save private exports, and create approved files.",
    authType: "oauth2",
    capabilities: ["read_business_records", "write_business_records", "import_content", "export_content"],
    requiredScopes: ["google.drive.read"],
    scopeLabels: ["Find files", "Read safe previews", "Create approved files"],
    connectionStatus: "not_connected",
    approvalPolicy: "per_sensitive_action",
    actions: [
      {
      ...
      {
        type: "write_record",
        safeLabel: "Create files",
        requiredCapabilities: ["write_business_records"],
        requiredScopes: ["google.drive.file"],
        approval: "always",
        sensitiveActionKind: "change_live_asset",
        handlerKey: "google_drive.write",
      },
      {
        type: "export_content",
        safeLabel: "Export files to Library",
        requiredCapabilities: ["read_business_records", "export_content"],
        requiredScopes: ["google.drive.read"],
        approval: "never",
  ...
  google_docs: {
    ...
    description: "Find relevant documents, save private exports, and create approved documents.",
    authType: "oauth2",
    capabilities: ["read_business_records", "write_business_records", "import_content", "export_content"],
    requiredScopes: ["google.drive.read", "google.docs.read"],
    scopeLabels: ["Find documents", "Read safe previews", "Create approved documents"],
    connectionStatus: "not_connected",
    approvalPolicy: "per_sensitive_action",
    actions: [
      {
      ...
      {
        type: "write_record",
        safeLabel: "Create documents",
        requiredCapabilities: ["write_business_records"],
        requiredScopes: ["google.docs.file"],
        approval: "always",
        sensitiveActionKind: "change_live_asset",
        handlerKey: "google_docs.write",
      },
      {
        type: "export_content",
        safeLabel: "Export documents to Library",
        requiredCapabilities: ["read_business_records", "export_content"],
        requiredScopes: ["google.drive.read", "google.docs.read"],
        approval: "never",
  ...
  google_sheets: {
    ...
    description: "Find relevant spreadsheets, save private exports, and create approved spreadsheets.",
    authType: "oauth2",
    capabilities: ["read_business_records", "write_business_records", "import_content", "export_content"],
    requiredScopes: ["google.drive.read", "google.sheets.read"],
    scopeLabels: ["Find spreadsheets", "Read safe previews", "Create approved spreadsheets"],
    connectionStatus: "not_connected",
    approvalPolicy: "per_sensitive_action",
    actions: [
      {
      ...
      {
        type: "write_record",
        safeLabel: "Create spreadsheets",
        requiredCapabilities: ["write_business_records"],
        requiredScopes: ["google.sheets.write"],
        approval: "always",
        sensitiveActionKind: "change_live_asset",
        handlerKey: "google_sheets.write",
      },
      {
        type: "export_content",
        safeLabel: "Export spreadsheets to Library",
        requiredCapabilities: ["read_business_records", "export_content"],
        requiredScopes: ["google.drive.read", "google.sheets.read"],
        approval: "never",
  ...
  github: {
    ...
    description: "Import repository context and create approved issues and pull requests.",
    authType: "github_app",
    capabilities: [
      "import_repository_context",
      "read_business_records",
    ...
    scopeLabels: ["Import repository context", "Create approved issues and pull requests"],
    connectionStatus: "not_connected",
    approvalPolicy: "per_sensitive_action",
    actions: [
      {
      ...
      },
      {
        ...
        safeLabel: "Create pull requests",
...
export const connectorActionHandlers: Record<string, ConnectorActionHandler> = {
  ...
  "google_drive.write": unsupportedActionHandler,
  ...
  "google_docs.write": unsupportedActionHandler,
  ...
  "google_sheets.write": unsupportedActionHandler,
...
export function safeActionSummary(actionType: string) {
  const labels: Record<string, string> = {
    ...
    write_record: "The approved record was created.",
    import_content: "Imported content is ready in Library.",
    export_content: "The export is ready in Library.",
