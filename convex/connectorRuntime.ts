...
export const connectorRegistry: Record<string, ConnectorDefinition> = {
  ...
  google_drive: {
    ...
    description: "Find relevant Drive files and read safe previews for answers and work context.",
    authType: "oauth2",
    capabilities: ["read_business_records", "import_content"],
    requiredScopes: ["google.drive.read"],
    scopeLabels: ["Find files", "Read safe previews"],
    connectionStatus: "not_connected",
    approvalPolicy: "per_sensitive_action",
    actions: [
      {
      ...
      {
        type: "export_content",
        safeLabel: "Export Library items",
        ...
        blockedSafeMessage: "Google Drive export is not live yet.",
      },
      {
        ...
        blockedSafeMessage: "Google Drive updates are not live yet.",
      },
    ],
  },
  google_docs: {
    ...
    description: "Find relevant documents and read safe previews for answers and work context.",
    authType: "oauth2",
    capabilities: ["read_business_records", "import_content"],
    requiredScopes: ["google.drive.read", "google.docs.read"],
    scopeLabels: ["Find documents", "Read safe previews"],
    connectionStatus: "not_connected",
    approvalPolicy: "per_sensitive_action",
    actions: [
      {
      ...
      {
        type: "export_content",
        safeLabel: "Export documents",
        requiredCapabilities: ["write_business_records", "export_content"],
        requiredScopes: [],
        approval: "blocked",
        sensitiveActionKind: "change_live_asset",
        handlerKey: "google_docs.export",
        blockedSafeMessage: "Google Docs export is not live yet.",
      },
      {
        type: "update_external_record",
        ...
        blockedSafeMessage: "Google Docs updates are not live yet.",
      },
    ],
  },
  google_sheets: {
    ...
    description: "Find relevant spreadsheets and read safe previews for answers and work context.",
    authType: "oauth2",
    capabilities: ["read_business_records", "import_content"],
    requiredScopes: ["google.drive.read", "google.sheets.read"],
    scopeLabels: ["Find spreadsheets", "Read safe previews"],
    connectionStatus: "not_connected",
    approvalPolicy: "per_sensitive_action",
    actions: [
      {
      ...
      {
        type: "export_content",
        safeLabel: "Export spreadsheets",
        requiredCapabilities: ["write_business_records", "export_content"],
        requiredScopes: [],
        approval: "blocked",
        sensitiveActionKind: "change_live_asset",
        handlerKey: "google_sheets.export",
        blockedSafeMessage: "Google Sheets export is not live yet.",
      },
      {
        type: "update_external_record",
        ...
        blockedSafeMessage: "Google Sheets updates are not live yet.",
      },
    ],
  },
  github: {
